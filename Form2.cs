...
namespace Sisconcad
{
    public partial class FormPacientes : Form
    {
        ...
        public void RefreshGrid()
        {
            try
            {
                conexao = new SqlConnection("Server = DESKTOP-GVVKSFK\\SQLEXPRESS; Database = db_sisconcad; User Id=sa; Password=1234;");
        ...
        private void FormPacientes_Load(object sender, System.EventArgs e)
        {
            RefreshGrid();
            labelFichaNum.Text = GetLastId();
            comboBoxRegistros.Items[2] = GetLastId();
        }
        ...
        private void buttonPesquisar_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "SELECT * FROM Pacientes WHERE id_paciente LIKE " + fPalavra_chave +
